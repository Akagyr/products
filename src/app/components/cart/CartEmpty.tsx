...
export default function CartEmpty() {
  ...
  return (
    <div className='flex flex-col items-center justify-center px-[15px] pb-[50px]'>
      ...
      <h2 className='mb-[10px] text-2xl font-semibold text-gray-800 md:text-3xl'>
      ...
      >
        ...
        <ArrowRightIcon styleClass='h-[16px] w-0 overflow-hidden transition-all duration-300 lg:group-hover:ml-[10px] lg:group-hover:w-[16px]' />
      </Link>
      <button
        onClick={() => router.back()}
      ...
      >
        <ArrowRightIcon styleClass='h-[16px] w-0 rotate-180 overflow-hidden transition-all duration-300 lg:group-hover:mr-[10px] lg:group-hover:w-[16px]' />
