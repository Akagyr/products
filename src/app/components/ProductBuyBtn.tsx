...
export default function ProductBuyBtn({
  ...
  return (
    <button
      ...
      } ${styleClasses ? styleClasses : 'px-[10px] md:px-[30px] py-[8px]'} text-sm md:text-base rounded-full w-full md:w-fit lg:hover:transition-colors lg:hover:duration-500 cursor-pointer`}
      disabled={isClicked}
