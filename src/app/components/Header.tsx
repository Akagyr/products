...
export default function Header() {
  return (
    <header className='sticky top-0 left-0 flex items-center justify-between font-medium px-[50px] py-[5px] shadow-[0_1px_15px_rgba(0,0,0,.12)]'>
      <Link href='/' className='flex flex-col items-center'>
        <Image src='/logo.png' width={50} height={50} alt='Orchids logo' />
        <h1 className='uppercase font-semibold text-sm'>Orchids</h1>
      </Link>
      <menu className='flex items-center gap-[20px] uppercase text-sm'>
